#!/usr/bin/env node
/**
 * Copies unchanged files from templates/react/xcm-api into Hygen templates
...
const sourceRoot = path.join(__dirname, '../../templates/react/xcm-api');
const targetRoot = path.join(__dirname, '../_templates/xcm-api-react/new');
...
console.log('Done bootstrapping XCM API React static templates.');
