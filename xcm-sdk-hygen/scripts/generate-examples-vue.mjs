...
const generateScript = path.join(__dirname, 'generate-vue.mjs');
...
function runGenerate(example) {
  return new Promise((resolve, reject) => {
    const args = [
      ...
      '--out',
      `generated/examples/vue/${example.dir}`,
    ];
...
async function main() {
  ...
  console.log(
    `\nGenerated ${EXAMPLES.length} Vue example apps under generated/examples/vue/`,
  );
}
