...
const generateScript = path.join(__dirname, 'generate-sdk-vue.mjs');
...
function runGenerate(example) {
  return new Promise((resolve, reject) => {
    const args = [
      ...
      '--out',
      `generated/xcm-sdk/vue/${example.dir}`,
    ];
...
async function main() {
  ...
  console.log(
    `\nGenerated ${EXAMPLES.length} Vue example apps under generated/xcm-sdk/vue/`,
  );
}
