...
const generateScript = path.join(__dirname, 'generate-node.mjs');
...
function runGenerate(example) {
  return new Promise((resolve, reject) => {
    const args = [
      ...
      '--out',
      `generated/examples/node/${example.dir}`,
    ];
...
async function main() {
  ...
  console.log(
    `\nGenerated ${EXAMPLES.length} Node example apps under generated/examples/node/`,
  );
}
