...
const generateScript = path.join(__dirname, 'generate-sdk-react.mjs');
...
function runGenerate(example) {
  return new Promise((resolve, reject) => {
    const args = [
      ...
      '--out',
      `generated/xcm-sdk/react/${example.dir}`,
    ];
...
async function main() {
  ...
  console.log(
    `\nGenerated ${EXAMPLES.length} React example apps under generated/xcm-sdk/react/`,
  );
}
