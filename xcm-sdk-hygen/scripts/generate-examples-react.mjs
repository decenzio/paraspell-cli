...
const generateScript = path.join(__dirname, 'generate-react.mjs');
...
function runGenerate(example) {
  return new Promise((resolve, reject) => {
    const args = [
      ...
      '--out',
      `generated/examples/react/${example.dir}`,
    ];
...
async function main() {
  ...
  console.log(
    `\nGenerated ${EXAMPLES.length} React example apps under generated/examples/react/`,
  );
}
